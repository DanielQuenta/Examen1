...
<section id="productos">
    <h2 class="producto-titulo">Productos Destacados</h2>
            ...
            <?php if (!empty($productos)): ?>
                <?php foreach ($productos as $producto): ?>
                    <tr>
                        ...
                        <td><?php echo htmlspecialchars($producto['precio']); ?> BS.</td>
                        ...
                        <td>
                            <a href="../controllers/ProductoController.php?action=edit&id=<?php echo $producto['idproducto']; ?>" class="producto-enlace btn btn-warning btn-sm">Editar</a>
                            <a href="../controllers/ProductoController.php?action=delete&id=<?php echo $producto['idproducto']; ?>" class="producto-enlace btn btn-danger btn-sm" onclick="return confirm('¿Estás seguro de que deseas eliminar este producto?')">Eliminar</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            <?php else: ?>
