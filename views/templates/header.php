...
<body>
    <header>
    <div class="titulo">
            <a href="welcome2.php"><img class="logo" src="img/logo/logocine.png" width="100" alt="logocine" height="80"></a>
        ...
        <div class="slider">
            <div>
                ...
                <a href="http://localhost/CODIGOs/venta_perifericos/controllers/ProductoController.php?action=show&id=10"><img src="img/slider/slider2.jpg" alt=""></a>
